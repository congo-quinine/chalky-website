...
class Releases extends Component {
    ...
    render(){
      ...
      return (
          <div onTouchStart={ () => this.props.handleNavBarHide()} onPointerEnter={ (event) => {this.props.handleNavBarHide(); this.props.handleNavSideBarChange(release)}} className='release-page-wrappper'>
